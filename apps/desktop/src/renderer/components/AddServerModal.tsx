...
export function AddServerModal({ isOpen, onClose, onAdd }: AddServerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-vanilla-dark-100 border border-vanilla-dark-300 rounded-2xl w-full max-w-md p-6 shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-white">Add Custom DNS</h2>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">
                Secondary DNS <span className="text-gray-500">(optional)</span>
              </label>
              <input
                type="text"
                value={secondary}
